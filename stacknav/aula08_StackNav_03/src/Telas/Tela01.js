...
export default function Tela01() {
  ...
  let img = require("../Img/mercurio.png"); // Lembre-se de ter essa imagem na pasta Img
  ...
  return (
    <ScrollView contentContainerStyle={estilos.fundo}>
      ...
      <View style={estilos.botoesContainer}>
        ...
        <View style={estilos.botao}>
          <Button title="PRÓXIMO PLANETA" onPress={() => nav.navigate("Tela02" as never)} color="#4682b4" />
        </View>
      </View>
    </ScrollView>
  );
